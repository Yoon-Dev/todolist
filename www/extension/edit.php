        ...
        <form action="" method="post">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 text-center">
                        <label for="detail"><span>Detail</span><br><textarea class="input-form textarea-field" name="detail" id="" ><?php echo $t_edit->detail(); ?></textarea></label>
                    </div>
                    <div class="col-xl-3 text-center">
    ...
    <form action="" method="post">
        ...
        <a class="lien-select-form lien-select-form_click" href="#repe">EDIT</a>
            <div class="row">
                ...
                <div class="col-xl-3 text-center">
                    <label for="detail_repe"><span>Detail</span><br><textarea name="detail_repe"
                            class="input-form textarea-field" id=""><?php echo $r_edit->detail();?></textarea></label>
                </div>
                <div class="col-xl-3 text-center">
